...
class _ProductListScreenState extends State<ProductListScreen> {
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              return ProductItem(
                ...
                onEdit: ()=> _navigateAndUpdateProduct(context,productList[index]),
              );
            },
          ),
        ),
  ...
  Future<void> _navigateAndUpdateProduct(BuildContext context, Product product) async {
    ...
    if (updatedProduct != null) {
      Product product = updatedProduct as Product;
      setState(() {
